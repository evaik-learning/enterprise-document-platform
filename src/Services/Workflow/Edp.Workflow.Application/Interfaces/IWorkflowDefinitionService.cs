...
public interface IWorkflowDefinitionService
{
    ...
    Task<WorkflowState> AddStateAsync(Guid organizationId, Guid versionId, string name, StateType stateType, Dictionary<string, string>? configuration, IReadOnlyList<AssignmentRule>? assignmentRules = null, IReadOnlyList<Guid>? approverUserIds = null, CancellationToken cancellationToken = default);
